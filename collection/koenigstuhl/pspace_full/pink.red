...
PIN      123    ; almost forgot to hide this one :-)
rndlmt   equ    20 ; number of trial rounds - some small number < 20
tscore   equ    24 ; acceptable trial score - aggressive
pzero    equ    123            ; somewhere in pspace
prndcnt  equ    (pzero-2)
pscore   equ    (pzero-8)
